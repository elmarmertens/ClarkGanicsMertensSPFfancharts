...
The replication package contains code and all input data in its raw form, obtained from the original sources as low.
...
A copy of this replication package is also maintained at https://github.com/elmarmertens/ClarkGanicsMertensSPFfancharts. The commit used to produce the resutls for this paper is tagged as [CGMreplicationPackageREStat](https://github.com/elmarmertens/ClarkGanicsMertensSPFfancharts/releases/tag/CGMreplicationPackageREStat).
...
In case of updating the data, please adapt the end of the sample in the appropriate scripts as indicated by comments therein (see variable `SPFsamstop` in the script [collectData.m](https://github.com/elmarmertens/ClarkGanicsMertensSPFfancharts/blob/main/rawdataKensington/collectData.m) and its variants). 
