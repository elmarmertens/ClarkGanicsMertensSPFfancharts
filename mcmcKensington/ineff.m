function inff = ineff(betas)
gew  = momentg(betas);
inff = zeros(size(betas,2),1);

for i = 1:size(betas, 2)
    inff(i, 1) = 1 / gew(i).rne1;
    inff(i, 2) = 1 / gew(i).rne2;
    inff(i, 3) = 1 / gew(i).rne3;
end
...
tmp     = struct('pmean', [], 'pstd', [], 'nse', [], 'rne', [], 'nse1', [], 'rne1', [], 'nse2', [], 'rne2', [], 'nse3', [], 'rne3', []);
results = repmat(tmp, nvar, 1);
