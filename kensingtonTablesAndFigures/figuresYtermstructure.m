%% plots term structure of expectations
...
for d = 2 % 1 : length(DATALABELS)
    ...
    wrap = [];
    titlename = sprintf('termstructure-%s-%s', datalabel, modeltype);
    %     initwrap
    ...
    for thisT = tndx
        ...
        if doShowSPFdata
            ...
            hl = legend([h1, hSPF], modelpretty, spfLegend{:}, 'location', 'best');
            ylim(ylimits)
