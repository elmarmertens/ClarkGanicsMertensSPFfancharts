...
datalabel  = 'PGDP'; % set variable, options are 'RGDP', 'PGDP', 'UNRATE'
fontsize   = 18;
...
%% latexwrapper
wrap   = [];
titlename = strcat('kensingtonTable1since2009-', datalabel);
...
tabname    = sprintf('table1since2009-%s.tex', datalabel);
tabcaption = tabname;
